...
namespace CustomMusicMod
{
    public class Main : MelonMod
    {
        ...
        private void LoadAllCustomWavs()
        {
        ...
        public override void OnGUI()
        {
            ...
            if (System.Math.Abs(newVolume - masterVolume) > 0.01f)
            {
        ...
        private void ForcePlaySong(string songName)
        {
            ...
            foreach (var source in sources)
            {
                ...
                // Ищем именно музыкальный источник (длиной от 10 сек или уже с кастомным треком)
